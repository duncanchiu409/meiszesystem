                    ...
                    .map((id) => {
                      return (
                              <tr>
                                ...
                                <td style={{textAlign: "center"}}>{Contract[id].buyer}</td>
                                <td style={{textAlign: "center"}}>{Contract[id].date}</td>
                                <td style={{textAlign: "center"}}>{Contract[id].item}</td>
                                <td style={{textAlign: "center"}}>{Contract[id].quantity}</td>
                                <td style={{textAlign: "center"}}>${Contract[id].price}</td>
                                <td style={{textAlign: "center"}}>${Contract[id].total}</td>
                                <td style={{textAlign: "center"}}>
                                  <NavLink to={`update/${id}`}  className='btn-edit' >Edit</NavLink>
                                  <button className='btn-delete' onClick={() => {if(window.confirm("Are you sure that you wanted to delete that contract?")){remove(ref(db, 'Contract/' + id)); window.location.reload(true);}}}>Delete</button>
