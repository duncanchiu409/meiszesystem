...
const UpdateQuotation = () => {
   ...
   },[id,Quotation.no,Quotation.date, Quotation.item, Quotation.quantity, Quotation.price, Quotation.total]);
    ...
    return (
      <div className="main">
        ...
        <div style={{padding: "0px 215px"}} className="container" >
                  <h1>Edit Quotation #{Quotation.no}</h1>
              ...
              />
                      <div className='text-center'>
                          <button className='btn-create' onClick={createUser}>Edit Quotation</button>
                          <NavLink to="/mainmeun/sale/quotation" className='btn-delete'>Cancel</NavLink>
                      </div>
