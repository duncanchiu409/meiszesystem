...
const UpdateAccountReceivable = () => {
    ...
    const createUser = () => {
        ...
        set(ref(db,'accountreceivable/' + id),{
          amount:newAmount, 
          date:newDate, 
    ...
    useEffect(() => {
      ...
      setNewAmount(accountReceivable.amount);
      setNewDate(accountReceivable.date);
      setNewDescription(accountReceivable.description);
        
     },[id,accountReceivable.amount,accountReceivable.date,accountReceivable.description]);
...
export default UpdateAccountReceivable
