              ...
              <table className="styled-table" ref={tableRef}>
                ...
                <tbody>
                    ...
                    .map((id) => {
                      return (
                              <tr>
                                <td style={{textAlign: "center"}}>{Service[id].name}</td>
                                <td style={{textAlign: "center"}}>{Service[id].description}</td>
                                <td style={{textAlign: "center"}}>{Service[id].remark}</td>
                                <td style={{textAlign: "center"}}>
                                  <NavLink to={`update/${id}`}  className='btn-edit' >Edit</NavLink>
                                  <button className='btn-delete' onClick={() => {if(window.confirm("Are you sure that you wanted to delete that service?")){remove(ref(db, 'Service/' + id)); window.location.reload(true);}}}>Delete</button>
